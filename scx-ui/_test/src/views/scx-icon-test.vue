...
export default {
    ...
    setup() {
        ...
        const filledIconList = getSvgNameList(import.meta.glob("../../../scx-vite-plugin/scx-icon-vite-plugin/default-svg-icons/filled/*.svg"), {eager: true});
        const outlinedIconList = getSvgNameList(import.meta.glob("../../../scx-vite-plugin/scx-icon-vite-plugin/default-svg-icons/outlined/*.svg", {eager: true}));
